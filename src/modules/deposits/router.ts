...
const makeRouter = async ({ dbConnection }: IBaseAppInput) => {
  ...
  const routes: IRoute[] = [
    ...
    { method: 'get', path: '/cashflows', middlewares: [authMiddleware], controller: controller.retrieveCashflowsController },
    { method: 'get', path: '/cashflows/export', middlewares: [authMiddleware], controller: controller.exportCashflowsController },
    { method: 'get', path: '/cashflows/export-download', middlewares: [authMiddleware], controller: controller.downloadCashflowsExportController },
    ...
    { method: 'post', path: '/:id/extend', middlewares: [authMiddleware], controller: controller.extendController },
