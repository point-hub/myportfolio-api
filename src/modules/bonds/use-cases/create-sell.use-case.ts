 ...
 */
export class CreateSellUseCase extends BaseUseCase<IInput, IDeps, ISuccessData> {
  async handle(input: IInput): Promise<IUseCaseOutputSuccess<ISuccessData> | IUseCaseOutputFailed> {
    ...
    const bondEntity = new BondEntity({
      disbursement_date: input.data?.disbursement_date,
      disbursement_bank_id: input.data?.disbursement_bank_id,
