...
import { CreateSellUseCase } from '../use-cases/create-sell.use-case';

export const createSellController: IController = async (controllerInput: IControllerInput) => {
  let session;
  try {
    ...
    const updateUseCase = new CreateSellUseCase({
      updateRepository,
      retrieveRepository,
