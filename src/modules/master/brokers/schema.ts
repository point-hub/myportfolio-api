...
export const schema: ISchema[] = [
  {
    ...
    schema: {
      ...
      properties: {
        ...
        code: {
          bsonType: 'string',
          description: 'The code of the broker entity.',
        },
        name: {
          bsonType: 'string',
          description: 'The name of the broker entity.',
        },
        branch: {
          bsonType: 'string',
          description: 'The branch of the broker entity.',
        },
        address: {
          bsonType: 'string',
          description: 'The address of the broker entity.',
        },
        phone: {
          bsonType: 'string',
        ...
        notes: {
          bsonType: 'string',
          description: 'Additional notes or information about the broker entity.',
        },
        is_archived: {
          bsonType: 'bool',
