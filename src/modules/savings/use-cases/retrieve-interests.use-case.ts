...
import type { IRetrieveInterestsRepository } from '../repositories/retrieve-interests.repository';
...
export interface IDeps {
  retrieveInterestsRepository: IRetrieveInterestsRepository
...
/**
 * Use case: Retrieve Saving Interests.
 *
 * Responsibilities:
 ...
 */
export class RetrieveInterestsUseCase extends BaseUseCase<IInput, IDeps, ISuccessData> {
  async handle(input: IInput): Promise<IUseCaseOutputSuccess<ISuccessData> | IUseCaseOutputFailed> {
    ...
    // Retrieve all data from the database.
    const response = await this.deps.retrieveInterestsRepository.handle(input.query);
